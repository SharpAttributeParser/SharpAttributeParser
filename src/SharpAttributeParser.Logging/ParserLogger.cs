...
/// <inheritdoc cref="IParserLogger{TCategoryName}"/>
public sealed class ParserLogger<TCategoryName> : IParserLogger<TCategoryName>
{
    ...
    /// <summary>Instantiates a <see cref="ParserLogger{TCategoryName}"/>, handling logging for <see cref="IParser"/>.</summary>
    /// <param name="logger">The logger used to log messages.</param>
    public ParserLogger(ILogger<TCategoryName> logger)
    {
    ...
    ITypeArgumentLogger IParserLogger.Type => TypeArgument;
    IConstructorArgumentLogger IParserLogger.Constructor => ConstructorArgument;
    INamedArgumentLogger IParserLogger.Named => NamedArgument;

    IDisposable? IParserLogger.BeginScopeParsingAttribute(Type recorderType, AttributeData attributeData, AttributeSyntax attributeSyntax)
    {
    ...
    void IParserLogger.SemanticParserFailedToParseAttribute() => MessageDefinitions.SemanticParserFailedToParseAttribute(Logger, null);
    void IParserLogger.SyntacticParserFailedToParseAttribute() => MessageDefinitions.SyntacticParserFailedToParseAttribute(Logger, null);
