...
public class ParamsArguments_IReadOnlyList
{
    private static (Location Collection, IReadOnlyList<Location> Elements) Target(IArgumentLocator locator, IReadOnlyList<ExpressionSyntax> expressions) => locator.ParamsArguments(expressions);
