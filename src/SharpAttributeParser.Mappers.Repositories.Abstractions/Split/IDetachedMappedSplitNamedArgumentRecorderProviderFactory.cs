...
/// <summary>Handles creation of <see cref="IDetachedMappedSplitNamedArgumentRecorderProvider{TSemanticRecord, TSyntacticRecord}"/> related to named parameters.</summary>
...
public interface IDetachedMappedSplitNamedArgumentRecorderProviderFactory<TSemanticRecord, TSyntacticRecord>
{
    /// <summary>Creates a provider of recorders which invoke the provided recorders.</summary>
    /// <param name="semanticRecorder">The recorder responsible for recording arguments of the named parameter. The arguments provided to the recorder are:
    /// <list type="number">
    ...
    /// </param>
    /// <param name="syntacticRecorder">The recorder responsible for recording syntactic information about arguments of the named parameter. The arguments provided to the recorder are:
    /// <list type="number">
    /// <item>The record to which the argument is recorded.</item>
