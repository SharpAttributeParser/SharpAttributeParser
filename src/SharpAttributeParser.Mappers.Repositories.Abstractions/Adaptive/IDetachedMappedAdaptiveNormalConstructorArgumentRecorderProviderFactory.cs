...
/// <summary>Handles creation of <see cref="IDetachedMappedAdaptiveConstructorArgumentRecorderProvider{TCombinedRecord, TSemanticRecord}"/> related to non-optional, non-<see langword="params"/> constructor parameters.</summary>
...
public interface IDetachedMappedAdaptiveNormalConstructorArgumentRecorderProviderFactory<TCombinedRecord, TSemanticRecord>
{
    ...
    public abstract IDetachedMappedAdaptiveConstructorArgumentRecorderProvider<TCombinedRecord, TSemanticRecord> Create(Func<TCombinedRecord, object?, ExpressionSyntax, bool> combinedRecorder, Func<TSemanticRecord, object?, bool> semanticRecorder);

    /// <summary>Creates a provider of which invoke the provided recorders and return <see langword="true"/>.</summary>
    /// <param name="combinedRecorder">The recorder responsible for recording arguments of the constructor parameter when parsed with syntactic context. The arguments provided to the recorder are:
    /// <list type="number">
    /// <item>The record to which the argument is recorded.</item>
    /// <item>The argument that is recorded.</item>
    ...
    /// <exception cref="ArgumentNullException"/>
    /// <exception cref="InvalidOperationException"/>
    public abstract IDetachedMappedAdaptiveConstructorArgumentRecorderProvider<TCombinedRecord, TSemanticRecord> Create(Action<TCombinedRecord, object?, ExpressionSyntax> combinedRecorder, Action<TSemanticRecord, object?> semanticRecorder);
    ...
    /// <exception cref="ArgumentNullException"/>
    /// <exception cref="InvalidOperationException"/>
    public abstract IDetachedMappedAdaptiveConstructorArgumentRecorderProvider<TCombinedRecord, TSemanticRecord> Create<TArgument>(IArgumentPattern<TArgument> pattern, Func<TCombinedRecord, TArgument, ExpressionSyntax, bool> combinedRecorder, Func<TSemanticRecord, TArgument, bool> semanticRecorder);
    ...
    /// <exception cref="ArgumentNullException"/>
    /// <exception cref="InvalidOperationException"/>
    public abstract IDetachedMappedAdaptiveConstructorArgumentRecorderProvider<TCombinedRecord, TSemanticRecord> Create<TArgument>(IArgumentPattern<TArgument> pattern, Action<TCombinedRecord, TArgument, ExpressionSyntax> combinedRecorder, Action<TSemanticRecord, TArgument> semanticRecorder);
