...
public sealed class DetachedMappedAdaptiveParamsConstructorArgumentRecorderProviderFactory<TCombinedRecord, TSemanticRecord> : IDetachedMappedAdaptiveParamsConstructorArgumentRecorderProviderFactory<TCombinedRecord, TSemanticRecord>
{
    ...
    private static IDetachedMappedAdaptiveConstructorArgumentRecorderProvider<TCombinedRecord, TSemanticRecord> Create(IDetachedMappedCombinedConstructorArgumentRecorder<TCombinedRecord> combined, IDetachedMappedSemanticConstructorArgumentRecorder<TSemanticRecord> semantic)
    {
        if (combined is null)
        {
            throw new InvalidOperationException($"A {nameof(IDetachedMappedCombinedParamsConstructorArgumentRecorderFactory<object>)} produced a null {nameof(IDetachedMappedCombinedConstructorArgumentRecorder<object>)}.");
        }
