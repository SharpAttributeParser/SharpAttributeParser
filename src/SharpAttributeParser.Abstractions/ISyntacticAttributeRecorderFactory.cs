...
public interface ISyntacticAttributeRecorderFactory
{
    ...
    /// <param name="argumentMapper">Maps the attribute parameters to <see cref="ISyntacticAttributeConstructorArgumentRecorder"/>, responsible for recording syntactical information about arguments of that parameter.</param>
