...
public interface IAttributeRecorder
{
    ...
    /// <param name="parameter">The <see cref="IParameterSymbol"/> representing the parameter.</param>
    /// <param name="argument">The <see langword="params"/>-argument of the parameter.</param>
    ...
    /// <exception cref="ArgumentNullException"/>
    /// <exception cref="InvalidOperationException"/>
    public abstract bool TryRecordConstructorParamsArgument(IParameterSymbol parameter, IReadOnlyList<object?> argument, IReadOnlyList<ExpressionSyntax> syntax);
