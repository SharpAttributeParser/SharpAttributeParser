...
{
    private static IDetachedMappedSyntacticConstructorArgumentRecorder<TRecord> Target<TRecord>(IDetachedMappedSyntacticNormalConstructorArgumentRecorderFactory<TRecord> factory, Func<TRecord, ExpressionSyntax, bool> recorder) => factory.Create(recorder);
