...
{
    private static IDetachedMappedSyntacticConstructorArgumentRecorder<TRecord> Target<TRecord>(IDetachedMappedSyntacticNormalConstructorArgumentRecorderFactory<TRecord> factory, Action<TRecord, ExpressionSyntax> recorder) => factory.Create(recorder);
