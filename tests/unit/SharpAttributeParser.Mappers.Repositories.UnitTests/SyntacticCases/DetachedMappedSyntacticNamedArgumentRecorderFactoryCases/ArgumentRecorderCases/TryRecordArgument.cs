...
{
    private static bool Target<TRecord>(IDetachedMappedSyntacticNamedArgumentRecorder<TRecord> recorder, TRecord dataRecord, ExpressionSyntax syntax) => recorder.TryRecordArgument(dataRecord, syntax);
