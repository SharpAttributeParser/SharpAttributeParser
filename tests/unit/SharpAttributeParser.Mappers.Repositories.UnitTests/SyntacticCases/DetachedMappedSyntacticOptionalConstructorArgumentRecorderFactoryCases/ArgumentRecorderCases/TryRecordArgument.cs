...
{
    private static bool Target<TRecord>(IDetachedMappedSyntacticConstructorArgumentRecorder<TRecord> recorder, TRecord dataRecord, ExpressionSyntax syntax) => recorder.TryRecordArgument(dataRecord, syntax);
