...
{
    private static IDetachedMappedSyntacticTypeArgumentRecorder<TRecord> Target<TRecord>(IDetachedMappedSyntacticTypeArgumentRecorderFactory<TRecord> factory, Action<TRecord, ExpressionSyntax> recorder) => factory.Create(recorder);
