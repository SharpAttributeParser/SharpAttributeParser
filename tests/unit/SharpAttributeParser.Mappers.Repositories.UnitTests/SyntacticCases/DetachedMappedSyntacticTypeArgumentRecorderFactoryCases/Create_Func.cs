...
{
    private static IDetachedMappedSyntacticTypeArgumentRecorder<TRecord> Target<TRecord>(IDetachedMappedSyntacticTypeArgumentRecorderFactory<TRecord> factory, Func<TRecord, ExpressionSyntax, bool> recorder) => factory.Create(recorder);
