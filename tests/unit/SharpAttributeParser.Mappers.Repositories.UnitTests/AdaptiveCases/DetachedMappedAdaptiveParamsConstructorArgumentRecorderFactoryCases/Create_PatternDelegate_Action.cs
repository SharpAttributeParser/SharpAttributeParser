...
public sealed class Create_PatternDelegate_Action
{
    ...
    public void ValidPatternAndRecorders_UsesCombinedAndSemanticFactories()
    {
        ...
        context.CombinedFactoryMock.Setup(static (factory) => factory.Create(It.IsAny<Func<IArgumentPatternFactory, IArgumentPattern<object>>>(), It.IsAny<Action<object, object, OneOf<ExpressionSyntax, IReadOnlyList<ExpressionSyntax>>>>())).Returns(combinedRecorder);
