...
public sealed class Create_Pattern_Action
{
    ...
    public void ValidPatternAndRecorders_UsesCombinedAndSemanticFactories()
    {
        ...
        context.CombinedFactoryMock.Setup(static (factory) => factory.Create(It.IsAny<IArgumentPattern<object>>(), It.IsAny<Action<object, object, OneOf<ExpressionSyntax, IReadOnlyList<ExpressionSyntax>>>>())).Returns(combinedRecorder);
