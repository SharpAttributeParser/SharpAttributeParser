...
{
    private static IDetachedMappedAdaptiveConstructorArgumentRecorderProvider<TCombinedRecord, TSemanticRecord> Target<TCombinedRecord, TSemanticRecord>(IDetachedMappedAdaptiveNormalConstructorArgumentRecorderProviderFactory<TCombinedRecord, TSemanticRecord> factory, Func<TCombinedRecord, object?, ExpressionSyntax, bool> combinedRecorder, Func<TSemanticRecord, object?, bool> semanticRecorder) => factory.Create(combinedRecorder, semanticRecorder);
    ...
    public void NullSemanticRecorder_ArgumentNullException()
    {
        ...
        var exception = Record.Exception(() => Target(context.Factory, Mock.Of<Func<object, object?, ExpressionSyntax, bool>>(), null!));
    ...
    public void ValidRecorders_UsesCombinedAndSemanticFactories()
    {
        ...
        context.CombinedFactoryMock.Setup(static (factory) => factory.Create(It.IsAny<Func<object, object?, ExpressionSyntax, bool>>())).Returns(combinedRecorder);
