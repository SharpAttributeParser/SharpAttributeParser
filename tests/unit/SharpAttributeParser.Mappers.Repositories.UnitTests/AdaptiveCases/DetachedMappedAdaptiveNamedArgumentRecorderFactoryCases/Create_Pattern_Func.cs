...
{
    private static IDetachedMappedAdaptiveNamedArgumentRecorderProvider<TCombinedRecord, TSemanticRecord> Target<TCombinedRecord, TSemanticRecord, TArgument>(IDetachedMappedAdaptiveNamedArgumentRecorderProviderFactory<TCombinedRecord, TSemanticRecord> factory, IArgumentPattern<TArgument> pattern, Func<TCombinedRecord, TArgument, ExpressionSyntax, bool> combinedRecorder, Func<TSemanticRecord, TArgument, bool> semanticRecorder) => factory.Create(pattern, combinedRecorder, semanticRecorder);
    ...
    public void ValidPatternAndRecorders_UsesCombinedAndSemanticFactories()
    {
        ...
        context.CombinedFactoryMock.Setup(static (factory) => factory.Create(It.IsAny<IArgumentPattern<object>>(), It.IsAny<Func<object, object, ExpressionSyntax, bool>>())).Returns(combinedRecorder);
