...
public sealed class Create_Func
{
    ...
    public void NullSemanticRecorder_ArgumentNullException()
    {
        ...
        var exception = Record.Exception(() => Target(context.Factory, Mock.Of<Func<object, object?, OneOf<None, ExpressionSyntax>, bool>>(), null!));
    ...
    public void ValidRecorders_UsesCombinedAndSemanticFactories()
    {
        ...
        context.CombinedFactoryMock.Setup(static (factory) => factory.Create(It.IsAny<Func<object, object?, OneOf<None, ExpressionSyntax>, bool>>())).Returns(combinedRecorder);
