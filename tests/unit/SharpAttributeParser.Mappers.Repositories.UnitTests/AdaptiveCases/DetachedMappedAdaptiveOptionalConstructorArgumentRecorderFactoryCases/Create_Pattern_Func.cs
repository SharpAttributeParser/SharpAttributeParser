...
public sealed class Create_Pattern_Func
{
    ...
    public void ValidPatternAndRecorders_UsesCombinedAndSemanticFactories()
    {
        ...
        context.CombinedFactoryMock.Setup(static (factory) => factory.Create(It.IsAny<IArgumentPattern<object>>(), It.IsAny<Func<object, object, OneOf<None, ExpressionSyntax>, bool>>())).Returns(combinedRecorder);
