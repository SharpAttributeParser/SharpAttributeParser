...
{
    private static IDetachedMappedSemanticNamedArgumentRecorder<TRecord> Target<TRecord, TArgument>(IDetachedMappedSemanticNamedArgumentRecorderFactory<TRecord> factory, IArgumentPattern<TArgument> pattern, Func<TRecord, TArgument, bool> recorder) => factory.Create(pattern, recorder);
