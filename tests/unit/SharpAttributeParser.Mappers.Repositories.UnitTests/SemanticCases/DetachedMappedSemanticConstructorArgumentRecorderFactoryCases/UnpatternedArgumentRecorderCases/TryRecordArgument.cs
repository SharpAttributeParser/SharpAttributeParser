...
{
    private static bool Target<TRecord>(IDetachedMappedSemanticConstructorArgumentRecorder<TRecord> recorder, TRecord dataRecord, object? argument) => recorder.TryRecordArgument(dataRecord, argument);
