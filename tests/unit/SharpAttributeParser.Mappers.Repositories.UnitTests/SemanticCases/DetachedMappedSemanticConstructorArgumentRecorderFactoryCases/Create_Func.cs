...
{
    private static IDetachedMappedSemanticConstructorArgumentRecorder<TRecord> Target<TRecord>(IDetachedMappedSemanticConstructorArgumentRecorderFactory<TRecord> factory, Func<TRecord, object?, bool> recorder) => factory.Create(recorder);
