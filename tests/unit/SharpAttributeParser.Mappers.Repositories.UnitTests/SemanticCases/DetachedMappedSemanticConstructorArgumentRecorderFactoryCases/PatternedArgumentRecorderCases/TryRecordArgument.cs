...
{
    private static bool Target<TRecord, TArgument>(IDetachedMappedSemanticConstructorArgumentRecorder<TRecord> recorder, TRecord dataRecord, TArgument argument) => recorder.TryRecordArgument(dataRecord, argument);
