...
{
    private static IDetachedMappedSemanticConstructorArgumentRecorder<TRecord> Target<TRecord>(IDetachedMappedSemanticConstructorArgumentRecorderFactory<TRecord> factory, Action<TRecord, object?> recorder) => factory.Create(recorder);
