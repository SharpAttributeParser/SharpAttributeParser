...
{
    private static void Target<TRecorder, TRecorderFactory>(INamedMappingRepository<TRecorder, TRecorderFactory> repository, string parameterName, TRecorder recorder) => repository.AddNamedMapping(parameterName, recorder);
