...
{
    private static IDetachedMappedSplitConstructorArgumentRecorderProvider<TSemanticRecord, TSyntacticRecord> Target<TSemanticRecord, TSyntacticRecord>(IDetachedMappedSplitParamsConstructorArgumentRecorderProviderFactory<TSemanticRecord, TSyntacticRecord> factory, Func<TSemanticRecord, object?, bool> semanticRecorder, Func<TSyntacticRecord, OneOf<ExpressionSyntax, IReadOnlyList<ExpressionSyntax>>, bool> syntacticRecorder) => factory.Create(semanticRecorder, syntacticRecorder);
    ...
    public void NullSemanticRecorder_ArgumentNullException()
    {
        ...
        var exception = Record.Exception(() => Target(context.Factory, null!, Mock.Of<Func<object, OneOf<ExpressionSyntax, IReadOnlyList<ExpressionSyntax>>, bool>>()));
