...
{
    private static IDetachedMappedSplitConstructorArgumentRecorderProvider<TSemanticRecord, TSyntacticRecord> Target<TSemanticRecord, TSyntacticRecord, TArgument>(IDetachedMappedSplitNormalConstructorArgumentRecorderProviderFactory<TSemanticRecord, TSyntacticRecord> factory, Func<IArgumentPatternFactory, IArgumentPattern<TArgument>> patternDelegate, Action<TSemanticRecord, TArgument> semanticRecorder, Action<TSyntacticRecord, ExpressionSyntax> syntacticRecorder) => factory.Create(patternDelegate, semanticRecorder, syntacticRecorder);
