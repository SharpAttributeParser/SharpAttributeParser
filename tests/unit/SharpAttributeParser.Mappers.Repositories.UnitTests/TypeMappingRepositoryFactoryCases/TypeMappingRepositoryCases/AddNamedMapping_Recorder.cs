...
{
    private static void Target<TRecorder, TRecorderFactory>(ITypeMappingRepository<TRecorder, TRecorderFactory> repository, string parameterName, TRecorder recorder) => repository.AddNamedMapping(parameterName, recorder);
