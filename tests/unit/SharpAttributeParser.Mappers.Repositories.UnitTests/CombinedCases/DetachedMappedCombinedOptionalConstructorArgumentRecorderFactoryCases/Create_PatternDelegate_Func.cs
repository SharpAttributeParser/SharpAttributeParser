...
{
    private static IDetachedMappedCombinedConstructorArgumentRecorder<TRecord> Target<TRecord, TArgument>(IDetachedMappedCombinedOptionalConstructorArgumentRecorderFactory<TRecord> factory, Func<IArgumentPatternFactory, IArgumentPattern<TArgument>> patternDelegate, Func<TRecord, TArgument, OneOf<None, ExpressionSyntax>, bool> recorder) => factory.Create(patternDelegate, recorder);
