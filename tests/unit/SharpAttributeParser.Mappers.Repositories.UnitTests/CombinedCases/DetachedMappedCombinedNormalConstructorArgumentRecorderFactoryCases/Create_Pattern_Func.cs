...
{
    private static IDetachedMappedCombinedConstructorArgumentRecorder<TRecord> Target<TRecord, TArgument>(IDetachedMappedCombinedNormalConstructorArgumentRecorderFactory<TRecord> factory, IArgumentPattern<TArgument> pattern, Func<TRecord, TArgument, ExpressionSyntax, bool> recorder) => factory.Create(pattern, recorder);
