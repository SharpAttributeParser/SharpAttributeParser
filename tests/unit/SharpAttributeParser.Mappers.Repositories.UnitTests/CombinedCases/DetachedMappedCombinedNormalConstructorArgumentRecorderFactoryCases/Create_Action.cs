...
{
    private static IDetachedMappedCombinedConstructorArgumentRecorder<TRecord> Target<TRecord>(IDetachedMappedCombinedNormalConstructorArgumentRecorderFactory<TRecord> factory, Action<TRecord, object?, ExpressionSyntax> recorder) => factory.Create(recorder);
