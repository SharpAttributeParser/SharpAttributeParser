...
{
    private static IDetachedMappedCombinedNamedArgumentRecorder<TRecord> Target<TRecord, TArgument>(IDetachedMappedCombinedNamedArgumentRecorderFactory<TRecord> factory, IArgumentPattern<TArgument> pattern, Func<TRecord, TArgument, ExpressionSyntax, bool> recorder) => factory.Create(pattern, recorder);
