...
{
    private static bool Target(IMappedCombinedConstructorArgumentRecorder recorder, object? argument, ExpressionSyntax syntax) => recorder.TryRecordArgument(argument, syntax);
