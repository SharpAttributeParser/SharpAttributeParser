...
{
    private static bool Target<TRecord, TArgument>(IDetachedMappedCombinedConstructorArgumentRecorder<TRecord> recorder, TRecord dataRecord, TArgument argument, ExpressionSyntax syntax) => recorder.TryRecordArgument(dataRecord, argument, syntax);
