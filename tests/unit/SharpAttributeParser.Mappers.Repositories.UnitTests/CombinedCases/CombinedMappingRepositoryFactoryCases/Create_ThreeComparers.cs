...
{
    private static ICombinedMappingRepository<TRecord> Target<TRecord>(ICombinedMappingRepositoryFactory<TRecord> factory, IEqualityComparer<string> typeParameterNameComparer, IEqualityComparer<string> constructorParameterNameComparer, IEqualityComparer<string> namedParameterNameComparer, bool throwOnMultipleBuilds) => factory.Create(typeParameterNameComparer, constructorParameterNameComparer, namedParameterNameComparer, throwOnMultipleBuilds);
