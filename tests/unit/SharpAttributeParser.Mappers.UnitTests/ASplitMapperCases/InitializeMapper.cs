...
public sealed class InitializeMapper
{
    ...
    public void NullReturningRepositoryFactory_InvalidOperationException()
    {
        ...
        context.RepositoryFactoryMock.Setup((factory) => factory.Create(It.IsAny<IParameterComparer>(), It.IsAny<bool>())).Returns((ISplitMappingRepository<object, object>)null!);
