...
{
    private static IMappedSemanticTypeArgumentRecorder? Target<TSemanticRecord, TSyntacticRecord>(ASplitMapper<TSemanticRecord, TSyntacticRecord> mapper, ITypeParameterSymbol parameter, TSemanticRecord dataRecord) => mapper.TryMapTypeParameter(parameter, dataRecord);
