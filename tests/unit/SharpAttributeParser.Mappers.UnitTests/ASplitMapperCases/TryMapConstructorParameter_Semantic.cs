...
{
    private static IMappedSemanticConstructorArgumentRecorder? Target<TSemanticRecord, TSyntacticRecord>(ASplitMapper<TSemanticRecord, TSyntacticRecord> mapper, IParameterSymbol parameter, TSemanticRecord dataRecord) => mapper.TryMapConstructorParameter(parameter, dataRecord);
