...
public sealed class InitializeMapper
{
    ...
    public void NullReturningRepositoryFactory_InvalidOperationException()
    {
        ...
        context.RepositoryFactoryMock.Setup((factory) => factory.Create(It.IsAny<IEqualityComparer<string>>(), It.IsAny<bool>())).Returns((ISyntacticMappingRepository<object>)null!);
