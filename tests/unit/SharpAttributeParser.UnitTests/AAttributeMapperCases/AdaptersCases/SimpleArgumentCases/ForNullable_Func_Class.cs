...
public sealed class ForNullable_Func_Class
{
    ...
    {
        public static Func<Data<T>, object?, OneOf<ExpressionSyntax, IReadOnlyList<ExpressionSyntax>>, bool> Target(Func<Data<T>, T?, ExpressionSyntax, bool> recorder) => Adapters.SimpleArgument.ForNullable(recorder).Invoke;
    }
