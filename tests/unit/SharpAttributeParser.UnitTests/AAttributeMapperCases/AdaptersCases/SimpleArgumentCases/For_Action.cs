...
public sealed class For_Action
{
    ...
    {
        public static Func<Data<T>, object?, OneOf<ExpressionSyntax, IReadOnlyList<ExpressionSyntax>>, bool> Target(Action<Data<T>, T, ExpressionSyntax> recorder) => Adapters.SimpleArgument.For(recorder).Invoke;
    }
