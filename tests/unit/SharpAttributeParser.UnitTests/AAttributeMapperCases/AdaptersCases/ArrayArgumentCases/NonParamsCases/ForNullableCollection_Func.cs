...
public sealed class ForNullableCollection_Func
{
    ...
    {
        public static Func<Data<T>, object?, OneOf<ExpressionSyntax, IReadOnlyList<ExpressionSyntax>>, bool> Target(Func<Data<T>, IReadOnlyList<T>?, ExpressionSyntax, bool> recorder) => Adapters.ArrayArgument.NonParams.ForNullableCollection(recorder).Invoke;
    }
