...
public sealed class ForNullableElements_Func_Struct
{
    ...
    {
        public static Func<Data<T?>, object?, OneOf<ExpressionSyntax, IReadOnlyList<ExpressionSyntax>>, bool> Target(Func<Data<T?>, IReadOnlyList<T?>, ExpressionSyntax, bool> recorder) => Adapters.ArrayArgument.NonParams.ForNullableElements(recorder).Invoke;
    }
