...
public sealed class ForNullableCollection_Action
{
    ...
    {
        public static Func<Data<T>, object?, OneOf<ExpressionSyntax, IReadOnlyList<ExpressionSyntax>>, bool> Target(Action<Data<T>, IReadOnlyList<T>?, ExpressionSyntax> recorder) => Adapters.ArrayArgument.NonParams.ForNullableCollection(recorder).Invoke;
    }
