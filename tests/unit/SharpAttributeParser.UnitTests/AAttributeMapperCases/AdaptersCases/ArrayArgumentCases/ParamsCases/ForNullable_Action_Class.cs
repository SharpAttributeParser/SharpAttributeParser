...
public sealed class ForNullable_Action_Class
{
    ...
    public void SyntaxCollection_TrueAndRecorded()
    {
        ...
        TrueAndRecorded(new[] { "3", "4" }, value, syntax);
    }
    ...
    {
        public static Func<Data<T>, object?, OneOf<ExpressionSyntax, IReadOnlyList<ExpressionSyntax>>, bool> Target(Action<Data<T>, IReadOnlyList<T?>?, OneOf<ExpressionSyntax, IReadOnlyList<ExpressionSyntax>>> recorder) => Adapters.ArrayArgument.Params.ForNullable(recorder).Invoke;
    }
