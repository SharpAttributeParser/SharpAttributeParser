...
public sealed class For_Action
{
    ...
    {
        public static Func<Data<T>, object?, OneOf<ExpressionSyntax, IReadOnlyList<ExpressionSyntax>>, bool> Target(Action<Data<T>, IReadOnlyList<T>, OneOf<ExpressionSyntax, IReadOnlyList<ExpressionSyntax>>> recorder) => Adapters.ArrayArgument.Params.For(recorder).Invoke;
    }
