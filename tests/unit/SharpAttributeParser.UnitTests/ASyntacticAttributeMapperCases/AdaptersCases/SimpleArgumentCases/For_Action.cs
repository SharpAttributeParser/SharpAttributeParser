...
public sealed class For_Action
{
    ...
    {
        public static Func<Data, OneOf<ExpressionSyntax, IReadOnlyList<ExpressionSyntax>>, bool> Target(Action<Data, ExpressionSyntax> recorder) => Adapters.SimpleArgument.For(recorder).Invoke;
    }
