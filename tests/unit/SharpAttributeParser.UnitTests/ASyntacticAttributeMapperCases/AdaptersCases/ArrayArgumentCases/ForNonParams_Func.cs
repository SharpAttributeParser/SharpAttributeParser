...
public sealed class ForNonParams_Func
{
    ...
    {
        public static Func<Data, OneOf<ExpressionSyntax, IReadOnlyList<ExpressionSyntax>>, bool> Target(Func<Data, ExpressionSyntax, bool> recorder) => Adapters.ArrayArgument.ForNonParams(recorder).Invoke;
    }
