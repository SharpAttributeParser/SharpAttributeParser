...
public sealed class For_Action_Array
{
    private static DSyntacticArrayRecorder Target<T>(ISyntacticAdapterProvider adapters, Action<IReadOnlyList<T>, CollectionLocation> recorder) where T : notnull => adapters.For(recorder);
