...
{
    private static DSyntacticSingleRecorder Target<T>(ISyntacticAdapterProvider adapters, Func<T?, Location, bool> recorder) where T : class => adapters.ForNullable(recorder);
