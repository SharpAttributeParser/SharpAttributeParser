...
{
    private static DSyntacticArrayRecorder Target<T>(ISyntacticAdapterProvider adapters, Func<IReadOnlyList<T?>, CollectionLocation, bool> recorder) where T : class => adapters.ForNullableElements(recorder);
