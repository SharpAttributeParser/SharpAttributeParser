...
{
    private static DSemanticArrayRecorder Target<T>(ISemanticAdapterProvider adapters, Func<IReadOnlyList<T?>, bool> recorder) where T : class => adapters.ForNullableElements(recorder);
