...
{
    private static DSemanticArrayRecorder Target<T>(ISemanticAdapterProvider adapters, Func<IReadOnlyList<T>?, bool> recorder) where T : notnull => adapters.ForNullableCollection(recorder);
