...
public sealed class For_Func_Array
{
    private static DSemanticArrayRecorder Target<T>(ISemanticAdapterProvider adapters, Func<IReadOnlyList<T>, bool> recorder) where T : notnull => adapters.For(recorder);
    ...
    [Fact]
    public void String_NullCollection_False_NotRecorded()
    {
    ...
    private static bool RecordArgument(ASemanticArgumentRecorder recorder, IReadOnlyList<object?>? value) => recorder.TryRecordNamedArgument(string.Empty, value);
