...
{
    private static DSemanticArrayRecorder Target<T>(ISemanticAdapterProvider adapters, Func<IReadOnlyList<T?>, bool> recorder) where T : struct => adapters.ForNullableElements(recorder);
