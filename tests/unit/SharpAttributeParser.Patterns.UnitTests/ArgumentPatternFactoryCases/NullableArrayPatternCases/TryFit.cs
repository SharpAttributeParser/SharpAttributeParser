namespace SharpAttributeParser.Patterns.ArgumentPatternFactoryCases.NullableArrayPatternCases;
...
public sealed class TryFit
{
    ...
    {
        var pattern = ((IArgumentPatternFactory)Context.Factory).NullableArray(elementPattern);
